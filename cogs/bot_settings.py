...
class BotSettings(utils.Cog):
    ...
    @commands.guild_only()
    async def setup2(self, ctx:utils.Context):
        ...
        menu.bulk_add_options(
            ctx,
            {
                ...
                'callback': self.bot.get_command("setup2 mod"),
            },
            {
                'display': "Modlog Settings",
                'callback': self.bot.get_command("setup2 modlog"),
            },
            {
                'display': "GeoPolitical Roleplay Settings",
                'callback': self.bot.get_command("setup2 georp"),
            },
        )
        try:
